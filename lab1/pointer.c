...
int withinSameBlock(int * ptr1, int * ptr2) {
  // TODO
  long int ones = ( ~0 ) << 6;
  long int intPtr1 = (long int) ptr1 & ones;
  long int intPtr2 = (long int) ptr2 & ones;
...
int withinArray(int * intArray, int size, int * ptr) {
  // TODO
  long int start = (long int) intArray;
  long int end = (long int) ( intArray + size - 1 );
  long int cur = (long int) ptr;
  return ( ( ~( cur - start ) ) >> 63 ) & ( ( ~( end - cur ) ) >> 63 ) & 1;
}
/*
