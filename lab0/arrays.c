...
int main(int argc, char* argv[]) {
  ...
  // Answer: The first argument of fillArray function is an adress, so we pass &value.
  fillArray(&value, 1);
  ...
  FourInts * heap_FourInts = (FourInts *) malloc(sizeof(int) * 4);
  fillArray(&heap_FourInts->a, 4);
